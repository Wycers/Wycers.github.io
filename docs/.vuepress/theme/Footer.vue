<template>
  <v-footer height="auto" class="blog-footer darken-1 mt-3">
    <v-card flat tile color="primary" class="primary--text text--lighten-4 text-xs-center py-3">
      ...
      <v-card-text class="pt-0 mt-1">
        ...
        <span>
          ...
          <a href="https://github.com/yscoder/vuepress-theme-indigo" target="_blank" rel="noopener noreferrer">indigo</a>
        </span>
      </v-card-text>
    </v-card>
  </v-footer>
